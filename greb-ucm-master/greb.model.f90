...
! control run
  print*,'% CONTROL RUN CO2=',CO2_ctrl,'  time=', time_ctrl,'yr nsteps per year', nstep_yr
...
! scenario run
  print*,'% SCENARIO EXP: ',log_exp,'  time=', time_scnr,'yr nsteps per year', nstep_yr
...
!    write output
  ...
  ! diagnostics: monthly means
     irec=irec+1; write(iunit,rec=irec)  Ts0
     irec=irec+1; write(iunit,rec=irec)  Ta0
     irec=irec+1; write(iunit,rec=irec)  To0
     irec=irec+1; write(iunit,rec=irec)  q0
     irec=irec+1; write(iunit,rec=irec)  albedo
